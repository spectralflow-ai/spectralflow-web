...
const THEATRES = [
  ...
  {
    t: "Sea",
    d: "Fully passive: nothing to detect, nothing to jam. Underwater navigation and magnetic-anomaly detection for submarines and AUVs, where satellite signals never reach.",
  },
  {
    t: "Space",
    d: "Diamond is intrinsically radiation-hard. Attitude determination and orbital navigation that keep working where conventional magnetometers drift under cosmic radiation.",
  },
];

const FUTURE = [
  {
    t: "Semiconductor metrology",
    d: "Non-perturbative imaging of next-generation chips and quantum processors at the nanoscale, without cryogenics.",
  },
  {
  ...
  },
  {
    ...
    d: "Room-temperature spin control as a building block for quantum information in ambient conditions.",
  },
];
    ...
    <main>
      <PageHeader
        ...
        title={
          <>
            Navigation first.
            <br className="hidden md:block" /> A platform behind it.
          </>
        }
