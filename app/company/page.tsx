...
export default function Company() {
  return (
    <main>
      <PageHeader
        eyebrow="Company"
        title={<>Taking quantum<br className="hidden md:block" /> out of the lab.</>}
      ...
      <Section bordered>
        <Reveal>
          ...
          <Lead className="max-w-3xl mb-4">
            The most powerful quantum sensors today are trapped behind cryostats, shielded rooms and
            optical tables. We believe the technology that wins is the one you can put on a drone, a
            hull or a satellite — rugged, low-power and ready to ship.
          </Lead>
      ...
      <Section bordered>
        <Reveal>
          ...
          <Lead className="max-w-3xl">
            ...
            should not depend on foreign supply chains or signals anyone can switch off. SpectralFlow
            builds a sovereign, European alternative — designed, patented and owned on the continent.
          </Lead>
        </Reveal>
      </Section>
      ...
      <Section bordered>
        <div className="grid grid-cols-1 md:grid-cols-[0.8fr_1.4fr] gap-10 items-start">
          <Reveal>
            <div className="card p-6 inline-block w-full max-w-[260px]">
              <div
                className="rounded-xl p-[1.5px] mb-4"
              ...
              <p className="font-semibold" style={{ color: "var(--text-primary)" }}>Alexandre Papa</p>
              <p className="font-mono text-xs mt-1" style={{ color: "var(--muted)" }}>Founder</p>
            </div>
          </Reveal>
          <Reveal delay={120}>
            ...
            <Body className="mb-4">
              ...
              path shapes how the company is run: rigorous on capital and execution, obsessive about
              the underlying physics.
            </Body>
            <Body>
              The conviction is simple — Europe has the science to lead in quantum sensing, and what
              it needs is a team that turns that science into manufacturable, field-ready products.
            </Body>
          </Reveal>
        </div>
      </Section>
      ...
      <Section bordered>
        <Reveal>
          ...
          <H2 className="max-w-3xl mb-10">Backed by a deep-tech ecosystem.</H2>
        </Reveal>
        <div className="grid grid-cols-1 md:grid-cols-[0.9fr_1.4fr] gap-6 items-stretch">
          <Reveal>
            <div className="card h-full flex flex-col items-start justify-between p-7">
              {/* White panel — the badge ships on white; do not alter it */}
              <div className="rounded-lg bg-white p-5 w-full flex items-center justify-center">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
              ...
              <p className="font-mono text-xs mt-5" style={{ color: "var(--muted)" }}>
                Member of NVIDIA Inception (2026)
              </p>
            </div>
          </Reveal>
          <Reveal delay={120}>
            <div className="card h-full p-7">
              ...
              <Body className="mb-4">
                We collaborate with public research institutions and an industrial network across
                the diamond, photonics and navigation value chains. We name partners publicly only
                once collaborations are confirmed and cleared to share.
              </Body>
              <Body>
                Interested in a research or industrial collaboration?{" "}
                <Link href="/contact" style={{ color: "var(--accent)" }}>Get in touch</Link>.
              </Body>
            </div>
          </Reveal>
        </div>
      ...
      <Section bordered>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <Reveal>
            ...
            <H2 className="mb-5">A defensible patent estate.</H2>
            <Body>
              ...
              that matter from physics to product.
            </Body>
          </Reveal>
          <Reveal delay={120}>
